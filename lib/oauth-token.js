...
function authenticateClient(req, body) {
  ...
  // ChatGPT may use a generated public OAuth client identifier with PKCE.
  // Public clients intentionally authenticate without a client secret.
  if (clientSecret) throw new Error('Unexpected client secret for public OAuth client.');
  return clientId;
}
