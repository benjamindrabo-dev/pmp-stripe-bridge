...
export default async function handler(req, res) {
  ...
  const result = { ok: Object.values(configured).every(Boolean), service: 'Pure Majesty Google Ads + GA4 MCP', version: '1.4.3-tracking-audit', google_ads_api_version: 'v25', configured };
