...
La disponibilité OXXO dans l'interface de production doit être vérifiée après déploiement. Ces tests ne constituent pas une transaction OXXO réelle réglée en magasin.
